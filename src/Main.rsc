...
int MAX_CLONE_SIZE = 75;

int TEST_MIN_CLONE_SIZE = 2;
...
map[str, value] cloneDetection(loc folder, str baseName, bool isType1, map[str, value] cloningData, bool isTest) {
    ...
    map[str, value] d3Data = transformToD3Format(cloningData);


    writeJSON(|cwd:///Results/<baseName>/cloning_data_<baseName>.txt|, d3Data, indent=1);
